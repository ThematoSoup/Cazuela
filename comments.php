...
?>
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav role="navigation" id="comment-nav-above" class="site-navigation comment-navigation">
			<h1 class="assistive-text"><?php _e( 'Comment navigation', 'thsp_cazuela' ); ?></h1>
			<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'thsp_cazuela' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'thsp_cazuela' ) ); ?></div>
	...
	?>
		<p class="nocomments"><?php _e( 'Comments are closed.', 'thsp_cazuela' ); ?></p>
	<?php endif; ?>
